...
from app.api.schemas.timeline import TimelineResponse, TimelineTaskResponse
...
async def get_timeline(
    ...
    if not tasks:
        return TimelineResponse(items=[], truncated=False)
    ...
    return TimelineResponse(items=results, truncated=truncated)
