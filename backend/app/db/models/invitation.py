...
from app.db.base import Base, RoleEnum, InvitationStatusEnum
...
class Invitation(Base):
    ...
    status: Mapped[InvitationStatusEnum] = mapped_column(default=InvitationStatusEnum.pending, nullable=False)
